...
class MenuBarController:
    def __init__(self, file_validator=FileValidator(), analysis_controller=AnalysisController()):
        self.file_validator = file_validator

    def load_file(self):
        filepath = filedialog.askopenfilename(filetypes=(("Audio files", "*.wav"), ("all files", "*.*")))
